...
def update_ratings (id1, id2, t1win, df, ot=False):
    ...
    r1 = table[table.team == id1]['rating'].values[0]
    rd1 = table[table.team == id1]['rd'].values[0]
    sig1 = table[table.team == id1]['volatility'].values[0]
    mu1 = (r1 - 1500)/173.7178
    phi1 = rd1/173.7178

    r2 = table[table.team == id2]['rating'].values[0]
    rd2 = table[table.team == id2]['rd'].values[0]
    sig2 = table[table.team == id2]['volatility'].values[0]    
    ...
    table.loc[table.team == id1, 'rating'] = r1
    table.loc[table.team == id1, 'rd'] = rd1
    table.loc[table.team == id1, 'volatility'] = sig1

#    table.loc[table.team == id2, 'rating'] = r2
#    table.loc[table.team == id2, 'rd'] = rd2
#    table.loc[table.team == id2, 'volatility'] = sig2
